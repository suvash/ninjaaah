...
void OgreCEGUI::createScene(void)
{
	...
	CEGUI::PushButton* quitBtn = (CEGUI::PushButton*)Wmgr->getWindow("OgreCEGUI/quitBtn");
	quitBtn->subscribeEvent(CEGUI::PushButton::EventClicked,CEGUI::Event::Subscriber(&OgreCEGUI::quit, this));

	//CEGUI::PushButton* launchBtn = (CEGUI::PushButton*)Wmgr->getWindow("OgreCEGUI/launchBtn");
...
{
	//CEGUI::Window* infoBox = (CEGUI::Window*)Wmgr->getWindow("OgreCEGUI/infoBox");
	//infoBox->setText("Demo Launched!");
	return true;
}*/
//-------------------------------------------------------------------------------------
